...
Teleporter is ready to run, you have just to run the tool through the script as described in the [Home page.](https://github.com/orientechnologies/teleporter/wiki)
